...
var _class = function (_Base) {
    ...
    _class.prototype.formAction = function formAction() {
        return this.display();
    };

    _class.prototype.gridAction = function gridAction() {
        return this.display();
    };

    _class.prototype.typographyAction = function typographyAction() {
        return this.display();
    };

    _class.prototype.buttonAction = function buttonAction() {
        return this.display();
    };

    _class.prototype.editorAction = function editorAction() {
        return this.display();
    };
